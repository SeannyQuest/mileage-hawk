...
const getCachedBestDeals = unstable_cache(
  fetchBestDealsData,
  ["api-prices-best-deals"],
  { revalidate: CACHE_DURATIONS.PRICES, tags: [CACHE_TAGS.PRICES, CACHE_TAGS.DEALS] }
);
...
export async function GET(request: Request) {
  try {
    ...
    const data = await getCachedBestDeals(region, cabinClass, limit, offset);
