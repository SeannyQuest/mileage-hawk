...
export const DEFAULT_THRESHOLDS: RegionThresholds[] = [
  {
    ...
    destinations: ["London", "Paris", "Berlin", "Rome", "Barcelona", "Madrid", "Athens", "Lisbon", "Dublin", "Stockholm", "Vienna", "Prague", "Mallorca"],
  ...
  },
  {
    ...
    destinations: ["Mexico City", "Cancun", "Cozumel", "Puerto Vallarta"],
  ...
  },
  {
    ...
    destinations: ["Bogota", "Medellin", "Rio de Janeiro"],
